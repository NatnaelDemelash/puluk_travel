...
const Guide = () => {
  return <section className='flexCenter flex-col'>
    ...
    <div className='flexCenter max-container relative w-full'>
      ...
      <div className='absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-3xl md:left-[5%] lg:top-20 shadow-md'>
        ...
        <div className='flexBetween flex-col'>  
            <div className='flex flex-col w-full'>
              ...
              <p className='bold-20 mt-2'>Mount Entoto</p>
            </div>

            <div className='flex flex-col w-full'>
                <p className='regular-16 text-gray-20'>Star track</p>
                <h4 className='bold-20 mt-2 whitespace-nowrap'>Mount Entoto</h4>
            </div>
          </div>
        </div>
      </div>
